...
- [ ] **The Round-Robin Service:** Write a backend service function that:
  ...
  - Analyzes _last month's_ assignments to track service frequency.
...
- [ ] **Auto Payment Confirmation:** Trigger a WhatsApp message to the House WhatsApp Group whenever the Treasurer logs a payment: _"✅ Payment received from [Member Name] for [Month]."_
...
_To be implemented after the core system is stable and gathering user feedback._
